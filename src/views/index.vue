    ...
    <loader :loading="loading">
      ...
      <template slot="body">
        ...
        <el-image style="animation: header-effect 2s"
                  ...
                  v-once
                  lazy
                  :src="!$common.isEmpty($store.state.webInfo.backgroundImage)?$store.state.webInfo.backgroundImage:$constant.random_image"
                  fit="cover">
        ...
        <div class="signature-wall myCenter my-animation-hideToShow">
          <h1 class="playful">
            <span v-for="(a, index) in $constant.mainContent" :key="index">{{a}}</span>
          </h1>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async getArticles() {
        await listArticle(this.pagination)
          .then((res) => {
