      ...
      <li class="tree-hole-li"
        ...
        <div class="tree-hole-content"
          ...
          <el-avatar shape="square" class="avatar-img" :size="36"
                     :src="!$common.isEmpty($store.state.user.current)?$store.state.user.current.avatar:$store.state.webInfo.avatar"></el-avatar>
          <div class="tree-hole-box"
            ...
            <div style="display: flex;justify-content: space-between">
              <div class="my-content">☞ {{treeHole.createdAt}}</div>
              <div @click="deleteTreeHole(treeHole.id)"
                   class="tree-hole-delete"
                   v-if="!$common.isEmpty($store.state.user.current) && $store.state.user.current.id === treeHole.userId">
