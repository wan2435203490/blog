  ...
  <div>
    <div class="favorite-container">
      ...
      <div class="favorite-header my-animation-slide-top">
        <!-- 背景图片 -->
        <video class="index-video" preload="auto" autoplay="autoplay" muted="muted" loop="loop"
               ref="videoPlayer" :src="$constant.favoriteVideo" >
<!--          :controls="true"-->
        </video>
...
<script>
  import {listCollect} from "@/api/web_info";
  ...
  export default {
    ...
    created() {
      ...
      //   //  this.$refs.videoPlayer.play()
      //
      //   // setTimeout(() => this.$refs.videoPlayer.muted = false, 1000)
      //   // this.$refs.videoPlayer.play();
      //
...
<style scoped>
  ...
  .card-item {
    ...
    height: 120px;
    border-radius: 20px;
    animation: hideToShow 2s ease-in-out;
    cursor: pointer;
    overflow: hidden;
    margin: 10px;
    color: var(--white);
