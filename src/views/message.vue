...
<script>
import {listTreeHole, saveTreeHole} from "@/api/web_info";
  ...
  export default {
    ...
    methods: {
      ...
      submitMessage() {
        ...
        if (!this.$common.isEmpty(this.$store.state.user.current) && !this.$common.isEmpty(this.$store.state.user.current.avatar)) {
          treeHole.avatar = this.$store.state.user.current.avatar;
        }
