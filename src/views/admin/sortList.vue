...
<script>
import {saveSort, saveLabel, getSortInfo, deleteLabel, deleteSort} from '@/api/web_info'
  ...
  export default {
    ...
    methods: {
      ...
      saveSortEdit() {
        ...
        this.sortForHttp.priority = parseInt(this.sortForHttp.priority)
        this.sortForHttp.sortType = parseInt(this.sortForHttp.sortType)

        saveSort(this.sortForHttp)
          .then((res) => {
            this.$message({
              message: "保存成功！",
              type: "success"
