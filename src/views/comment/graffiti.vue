  ...
  export default {
    ...
    methods: {
      ...
      getImage() {
        ...
        fd.append("key", "graffiti" + "/" + this.$store.state.user.current.username.replace(/[^a-zA-Z]/g, '') + this.$store.state.user.current.id + new Date().getTime() + Math.floor(Math.random() * 1000) + ".png");
